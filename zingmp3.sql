...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 16, 2024 lúc 01:05 PM
...
INSERT INTO `songs` (`id`, `background`, `name`, `singer`, `pathSong`, `duration`, `genre`) VALUES
...
INSERT INTO `users` (`userId`, `firstName`, `lastName`, `email`, `password`, `type`) VALUES
(6, 'a', 'a', 'a@gmail.com', 'a', ''),
(7, 'Phúc', 'Bùi', 'admin@psound.vn', '0', 'admin');
