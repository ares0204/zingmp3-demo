                    ...
                    <div class="header">
                        ...
                        <div class="header__right">
                            ...
                            <div class="header__user">
                                <a href="#">
                                    <img src="./assets/img/user/user.png" alt="user" class="header__user-img">
                                </a>
                ...
                <div class="main-container-pertional js__container-panes active">
                    <div class="profile">
                        <a href="./page/login.html">
                            <img src="./assets/img/user/user.png" alt="avatar" class="profile__img">
                        </a>
                                    ...
                                    <div class="col l-2-4 m-3 s-6 mobile-margin-bot-10px">
                                        <li class="option-all__playlist-item">
                                            ...
                                            <div class="option-all__playlist-item-content">
                                                ...
                                                <div class="option-all__playlist-item-content-name2 js__sub-color">Bùi Trần Thanh Phúc</div>
                                            </div>
                                        </li>
                                    </div>
                                    <div class="col l-2-4 m-3 s-6 mobile-margin-bot-10px">
